...
export const PermissionButton = ({ type, onGranted, onDenied }: PermissionButtonProps) => {
  ...
  const messages = {
    ...
    audio: {
      ...
      description: 'Allow microphone access to control the flame with your breath',
      ...
      if (type === 'motion') {
        ...
        if (
          ...
          if (permission === 'granted') {
            ...
            setError('Permission denied. Please enable motion sensors in your device settings.');
            onDenied();
          }
        } else {
